...
The data was taken as from the Machine Learning repository as explained below. It assumes the data was unzipped. All the files (plot1.R,plot2.R,plot3.R and plot4.R) assume that the data is present in the working directory. 
